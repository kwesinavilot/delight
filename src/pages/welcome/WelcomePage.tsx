          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Use the popup, side panel, or keyboard shortcut (Ctrl+Shift+Q). Try the AI tools for explaining, rewriting, and tone changes, plus attach page content for context.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center space-x-2 mb-4">
            ...
            <span className="bg-blue-500 text-white px-2 py-1 rounded-full text-xs font-semibold">v1.0.0</span>
          </div>
